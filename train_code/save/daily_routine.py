...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Graduate\\Research\\kraken\\backend\\daily_routine.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    sound_1 = sound.Sound('static/audios/准备1_静息.wav', secs=-1, stereo=True, hamming=True,
        name='sound_1')
    ...
    sound_7 = sound.Sound('static/audios/任务1_静息.wav', secs=-1, stereo=True, hamming=True,
        name='sound_7')
    sound_7.setVolume(1.0)
    sound_16 = sound.Sound('static/audios/ding.wav', secs=1.0, stereo=True, hamming=True,
        name='sound_16')
    ...
    sound_2 = sound.Sound('static/audios/准备2_肘部.wav', secs=-1, stereo=True, hamming=True,
        name='sound_2')
    ...
    elbow_img = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    sound_6 = sound.Sound('static/audios/任务2_肘部.wav', secs=-1, stereo=True, hamming=True,
        name='sound_6')
    ...
    image_2 = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    sound_8 = sound.Sound('static/audios/ding.wav', secs=1.5, stereo=True, hamming=True,
        name='sound_8')
    sound_8.setVolume(1.0)
    sound_9 = sound.Sound('static/audios/放松.wav', secs=-1, stereo=True, hamming=True,
        name='sound_9')
    ...
    sound_3 = sound.Sound('static/audios/准备3_被动.wav', secs=-1, stereo=True, hamming=True,
        name='sound_3')
    ...
    passive_img = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    sound_14 = sound.Sound('static/audios/任务3_被动.wav', secs=-1, stereo=True, hamming=True,
        name='sound_14')
    ...
    image_6 = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    sound_10 = sound.Sound('static/audios/ding.wav', secs=1.5, stereo=True, hamming=True,
        name='sound_10')
    sound_10.setVolume(1.0)
    sound_11 = sound.Sound('static/audios/放松.wav', secs=-1, stereo=True, hamming=True,
        name='sound_11')
    ...
    sound_4 = sound.Sound('static/audios/准备4_主动.wav', secs=-1, stereo=True, hamming=True,
        name='sound_4')
    ...
    active_img = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    sound_15 = sound.Sound('static/audios/任务4_主动.wav', secs=-1, stereo=True, hamming=True,
        name='sound_15')
    ...
    image_7 = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    sound_12 = sound.Sound('static/audios/ding.wav', secs=1.5, stereo=True, hamming=True,
        name='sound_12')
    sound_12.setVolume(1.0)
    sound_13 = sound.Sound('static/audios/放松.wav', secs=-1, stereo=True, hamming=True,
        name='sound_13')
    ...
    # --- Initialize components for Routine "done" ---
        ...
        languageStyle='LTR',
        depth=0.0);
    sound_5 = sound.Sound('static/audios/结束.wav', secs=-1, stereo=True, hamming=True,
        name='sound_5')
    ...
    thisExp.addData('prepare_0.started', globalClock.getTime())
    key_resp_4.keys = []
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    sound_1.setSound('static/audios/准备1_静息.wav', hamming=True)
    sound_1.setVolume(1.0, log=False)
    sound_1.seek(0)
    # keep track of which components have finished
    prepare_0Components = [text_4, key_resp_4, sound_1]
    ...
    thisExp.addData('prepare_0.stopped', globalClock.getTime())
    # check responses
    ...
    i=0
    sound_7.setSound('static/audios/任务1_静息.wav', secs=5, hamming=True)
    sound_7.setVolume(1.0, log=False)
    sound_7.seek(0)
    sound_16.setSound('static/audios/ding.wav', secs=1.0, hamming=True)
    sound_16.setVolume(1.0, log=False)
    sound_16.seek(0)
    # keep track of which components have finished
    restingComponents = [image_3, sound_7, sound_16]
    ...
    while continueRoutine and routineTimer.getTime() < 121.0:
        ...
        if sound_16.status == NOT_STARTED and tThisFlip >= 120-frameTolerance:
            # keep track of start time/frame for later
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('prepare_1.started', globalClock.getTime())
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    sound_2.setSound('static/audios/准备2_肘部.wav', hamming=True)
    ...
    # keep track of which components have finished
    prepare_1Components = [elbow_prepare, key_resp, sound_2]
    ...
    for thisComponent in prepare_1Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('prepare_1.stopped', globalClock.getTime())
    # check responses
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('task_1.started', globalClock.getTime())
        ...
        sound_6.setSound('static/audios/任务2_肘部.wav', hamming=True)
        sound_6.setVolume(1.0, log=False)
        sound_6.seek(0)
        # keep track of which components have finished
        task_1Components = [elbow_img, sound_6]
        ...
        for thisComponent in task_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('task_1.stopped', globalClock.getTime())
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('rest_1.started', globalClock.getTime())
        # Run 'Begin Routine' code from code_3
        win.callOnFlip(trigger.send_trigger,trigger_rest)
        sound_8.setSound('static/audios/ding.wav', secs=1.5, hamming=True)
        sound_8.setVolume(1.0, log=False)
        sound_8.seek(0)
        sound_9.setSound('static/audios/放松.wav', secs=3, hamming=True)
        sound_9.setVolume(1.0, log=False)
        sound_9.seek(0)
        # keep track of which components have finished
        rest_1Components = [image_2, sound_8, sound_9]
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if sound_8.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > sound_8.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if sound_9.status == NOT_STARTED and tThisFlip >= 1.2-frameTolerance:
                # keep track of start time/frame for later
            ...
            if sound_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > sound_9.tStartRefresh + 3-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        for thisComponent in rest_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('rest_1.stopped', globalClock.getTime())
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('prepare_2.started', globalClock.getTime())
    key_resp_2.keys = []
    key_resp_2.rt = []
    _key_resp_2_allKeys = []
    sound_3.setSound('static/audios/准备3_被动.wav', hamming=True)
    ...
    # keep track of which components have finished
    prepare_2Components = [passive_prepare, key_resp_2, sound_3]
    ...
    while continueRoutine:
        ...
        if sound_3.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
            # keep track of start time/frame for later
    ...
    for thisComponent in prepare_2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('prepare_2.stopped', globalClock.getTime())
    # check responses
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('task_2.started', globalClock.getTime())
        ...
        sound_14.setSound('static/audios/任务3_被动.wav', hamming=True)
        sound_14.setVolume(1.0, log=False)
        sound_14.seek(0)
        # keep track of which components have finished
        task_2Components = [passive_img, sound_14]
        ...
        while continueRoutine:
            ...
            if sound_14.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
                # keep track of start time/frame for later
        ...
        for thisComponent in task_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('task_2.stopped', globalClock.getTime())
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('rest_2.started', globalClock.getTime())
        # Run 'Begin Routine' code from code_5
        win.callOnFlip(trigger.send_trigger,0x05)
        hand_device.start('rest')
        sound_10.setSound('static/audios/ding.wav', secs=1.5, hamming=True)
        sound_10.setVolume(1.0, log=False)
        sound_10.seek(0)
        sound_11.setSound('static/audios/放松.wav', secs=3, hamming=True)
        sound_11.setVolume(1.0, log=False)
        sound_11.seek(0)
        # keep track of which components have finished
        rest_2Components = [image_6, sound_10, sound_11]
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if sound_10.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > sound_10.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if sound_11.status == NOT_STARTED and tThisFlip >= 1.2-frameTolerance:
                # keep track of start time/frame for later
            ...
            if sound_11.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > sound_11.tStartRefresh + 3-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        for thisComponent in rest_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('rest_2.stopped', globalClock.getTime())
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('prepare_3.started', globalClock.getTime())
    key_resp_3.keys = []
    key_resp_3.rt = []
    _key_resp_3_allKeys = []
    sound_4.setSound('static/audios/准备4_主动.wav', hamming=True)
    ...
    # keep track of which components have finished
    prepare_3Components = [active_prepare, key_resp_3, sound_4]
    ...
    for thisComponent in prepare_3Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('prepare_3.stopped', globalClock.getTime())
    # check responses
    ...
    for thisTrial_3 in trials_3:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('task_3.started', globalClock.getTime())
        ...
        sound_15.setSound('static/audios/任务4_主动.wav', hamming=True)
        sound_15.setVolume(1.0, log=False)
        sound_15.seek(0)
        # keep track of which components have finished
        task_3Components = [active_img, sound_15]
        ...
        while continueRoutine:
            ...
            if sound_15.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
                # keep track of start time/frame for later
        ...
        for thisComponent in task_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('task_3.stopped', globalClock.getTime())
        sound_15.pause()  # ensure sound has stopped at end of Routine
        # the Routine "task_3" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        
        # --- Prepare to start Routine "rest_3" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('rest_3.started', globalClock.getTime())
        # Run 'Begin Routine' code from code_7
        win.callOnFlip(trigger.send_trigger,trigger_rest)
        sound_12.setSound('static/audios/ding.wav', secs=1.5, hamming=True)
        sound_12.setVolume(1.0, log=False)
        sound_12.seek(0)
        sound_13.setSound('static/audios/放松.wav', secs=3, hamming=True)
        sound_13.setVolume(1.0, log=False)
        sound_13.seek(0)
        # keep track of which components have finished
        rest_3Components = [image_7, sound_12, sound_13]
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if sound_12.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > sound_12.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if sound_13.status == NOT_STARTED and tThisFlip >= 1.2-frameTolerance:
                # keep track of start time/frame for later
            ...
            if sound_13.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > sound_13.tStartRefresh + 3-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        for thisComponent in rest_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('rest_3.stopped', globalClock.getTime())
    ...
    sound_5.setSound('static/audios/结束.wav', hamming=True)
    sound_5.setVolume(1.0, log=False)
    sound_5.seek(0)
    # keep track of which components have finished
    doneComponents = [end, sound_5]
